...
def test_create_from_file_with_custom_header():
    data = '''# data file example
    "Gęśl";"_gĘśl 1";"gesl"
    1;2;3
    4;5;6
...
def test_create_from_file_no_header():
    ...
    with patch('__main__.open', mock_open(read_data=data), create=True) as m:
        t = meerkat.Table('data.csv', header=False)
...
def test_create_from_file_no_header_with_custom_header():
    data = '''# data file example
    1;2;3
    4;5;6
